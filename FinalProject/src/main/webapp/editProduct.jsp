...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
           ...
           <!--                          <label>ID</label> -->
                                    <input value="${detail.productID}" name="productID" type="hidden" class="form-control" readonly required>
                                </div> 
                                <div class="form-group">
                                    <label>Name</label>
                                    <input value="${detail.productName}" name="productName" type="text" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label>Image</label>
