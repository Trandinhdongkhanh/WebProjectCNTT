			...
			<div class="container">
				<div class="row mb-5">
					...
					<div class="col-md-5">
						...
						<p>At first, we were just a small store, but we always try our
							best to bring the best and best quality products to our
							customers. We received a lot of positive feedback from customers
							and decided to expand the store further. Our store has become
							more widely known.</p>
				...
				<div class="row">
						...
						<div class="block-38 text-center">
							<div class="block-38-img">
								<div class="block-38-header">
									<img src="images/Thach.jpg" alt="Image placeholder"
										class="mb-4">
									<h3 class="block-38-heading h4">Dao Ngoc Thach</h3>
					...
					<div class="col-md-6 col-lg-4">
						<div class="block-38 text-center">
							<div class="block-38-img">
								<div class="block-38-header">
									<img src="images/Khanh.jpg" alt="Image placeholder"
										class="mb-4">
									<h3 class="block-38-heading h4">Tran Dinh Dong Khanh</h3>
					...
					<div class="col-md-6 col-lg-4">
						<div class="block-38 text-center">
							<div class="block-38-img">
								<div class="block-38-header">
									<img src="images/ChiBao.jpg" alt="Image placeholder"
										class="mb-4">
									<h3 class="block-38-heading h4">Phan Chi Bao</h3>
